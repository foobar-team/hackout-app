...
List<SliderData> get getSliderData {
  List<SliderData> list = [
    ...
    SliderData(
        ...
        body:
            "Get the live location of your loved ones, get alerted when they are in distress",
    ...
    SliderData(
        head: "Get started",
        body: "Register with your email and unique identification.",
        imagePath: "assets/images/intro_five.png"),
  ];
  return list;
}
